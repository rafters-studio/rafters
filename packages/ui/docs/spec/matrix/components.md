...
|---|---|---|---|---|---|---|---|---|
| **alert** | Inline status banner with severity variants | Displays feedback content in flow; role=alert announces on appearance | - | - | - | transition-colors | astro/react/wc | react/wc/astro OK |
