...
export const selectTriggerBaseClasses =
  'flex w-full items-center justify-between gap-2 rounded-md border border-input bg-background px-3 text-body-small ts-body-small shadow-sm ring-offset-background hover:border-input-hover';
...
export const selectLabelClasses = 'py-1.5 pl-8 pr-2 text-label-medium ts-label-medium';

export const selectItemBaseClasses =
  'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-body-small ts-body-small outline-none';
