...
export const commandInputClasses =
  'flex h-10 w-full rounded-md bg-transparent py-3 ts-body-small outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50';

export const commandListClasses = 'max-h-80 overflow-y-auto overflow-x-hidden';

export const commandEmptyClasses = 'py-6 text-center ts-body-small';

export const commandGroupClasses = 'overflow-hidden p-1 text-foreground';

export const commandGroupHeadingClasses = 'px-2 py-1.5 ts-label-small text-muted-foreground';

export const commandItemClasses =
  'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 ts-body-small outline-none transition-colors duration-100 motion-reduce:transition-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[selected]:bg-accent data-[selected]:text-accent-foreground';

export const commandSeparatorClasses = '-mx-1 h-px bg-border';

export const commandShortcutClasses = 'ml-auto ts-shortcut text-muted-foreground';
