...
export const itemSizeClasses: Record<string, string> = {
  default: 'px-3 py-2 ts-body-small',
  sm: 'px-2 py-1.5 ts-label-small',
  lg: 'px-4 py-3 ts-body-medium',
};
...
export const itemDescriptionClasses = 'truncate text-muted-foreground ts-label-small mt-0.5';
