...
export const dialogTitleClasses = 'text-title-medium ts-title-medium leading-none';

export const dialogDescriptionClasses = 'text-body-small ts-body-small text-muted-foreground';
