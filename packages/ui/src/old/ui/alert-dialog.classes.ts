...
export const alertDialogTitleClasses = 'text-title-medium ts-title-medium';

export const alertDialogDescriptionClasses = 'text-body-small ts-body-small text-muted-foreground';

export const alertDialogActionClasses =
  'inline-flex h-10 items-center justify-center rounded-md bg-destructive px-4 py-2 text-label-medium ts-label-medium text-destructive-foreground ring-offset-background transition-colors duration-150 motion-reduce:transition-none hover:bg-destructive/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50';

export const alertDialogCancelClasses =
  'mt-2 inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-label-medium ts-label-medium ring-offset-background transition-colors duration-150 motion-reduce:transition-none hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 sm:mt-0';
