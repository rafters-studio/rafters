...
export const tooltipContentClasses =
  'z-depth-tooltip overflow-hidden rounded-md bg-foreground px-3 py-1.5 ts-body-small text-background shadow-lg transition-opacity duration-150 motion-reduce:transition-none';
