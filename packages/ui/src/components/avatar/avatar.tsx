...
import { avatar, type AvatarSize, type AvatarStatus, resolveAvatar } from './avatar.behavior';
import { avatarClasses, avatarFallbackClasses, avatarImageClasses } from './avatar.classes';
