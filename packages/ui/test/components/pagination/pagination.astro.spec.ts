 ...
 * nav[aria-label="Pagination"] root, and the slotted trail's earned semantics
 * (aria-current on the current page, aria-disabled on the boundary control,
 * aria-hidden on the ellipsis). Axe cleanliness for this markup is asserted in
 * the .a11y tier, not here.
 */
