 ...
 * and asserts the one contract a static surface can carry: the root region and
 * the named-slot structure with its data-slot markers. One score, three
 * performances; here the performance is markup + classes + slots, nothing
 * more.
 */
