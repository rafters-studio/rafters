/**
 * React performance of the Avatar score. Proves the empty ARIA projection,
 * the image/fallback presence rule driven by load status, and the classes
 * channel (size token + consumer className merge).
 */
...
describe('avatar conformance [react]', () => {
  it('fulfills the contract: root renders and projects NO ARIA', () => {
    ...
    const projection = avatar.aria({}, { size: 'md', status: 'loading' }, { root: root.id });
