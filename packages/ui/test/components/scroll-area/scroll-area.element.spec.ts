/**
 * Web Component performance of the ScrollArea score, run in a real browser.
 * ScrollArea is a pure static: no controller to drive, so the WC renders the
 * scroll-surface markup with the shared classes and a default slot, once,
 * and that is the whole performance.
 */
