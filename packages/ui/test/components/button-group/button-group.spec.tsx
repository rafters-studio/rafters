...
describe('button-group [react]', () => {
  it('fulfills the contract: root renders and carries role=group', () => {
    ...
    const projection = buttonGroup.aria(
      {},
  ...
  it('projects role=group regardless of orientation', () => {
    ...
    const root = container.querySelector<HTMLElement>('[data-part="root"]') as HTMLElement;
  ...
  it('orientation drives the connected-border layout classes', () => {
    ...
    let root = container.querySelector<HTMLElement>('[data-part="root"]') as HTMLElement;
    expect(root.className).toContain('flex-row');
    expect(root.className).toContain('[&>*:not(:first-child)]:-ml-px');
    rerender(<ButtonGroup orientation="vertical">x</ButtonGroup>);
    root = container.querySelector<HTMLElement>('[data-part="root"]') as HTMLElement;
