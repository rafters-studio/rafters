 ...
 */
export async function reactPlotSettled(scope: ParentNode, height = 200): Promise<void> {
  await expect
 ...
 */
export async function elementPlotSettled(scope: ParentNode, height = 200): Promise<void> {
  await expect
    .poll(() => {
