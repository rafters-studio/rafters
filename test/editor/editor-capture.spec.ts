/**
 * editor-capture.spec.ts (Playwright, REAL browser -- chromium/firefox/webkit
 ...
 *
 * No dev server (see test/presence/presence-exit.spec.ts): `about:blank` +
...
import { parseCaret } from '../../packages/ui/test/components/editor/caret';
import {
  EDITOR_SCENARIOS,
  type EditorScenario,
} from '../../packages/ui/test/components/editor/editor-scenarios';
