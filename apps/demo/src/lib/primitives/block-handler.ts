 ...
 */
import { atom } from 'nanostores';
import type { BlockCanvasBlock } from '@/lib/primitives/block-canvas';
import { createBlockCanvas } from '@/lib/primitives/block-canvas';
import { createClipboard } from '@/lib/primitives/clipboard';
import { createHistory } from '@/lib/primitives/history';
