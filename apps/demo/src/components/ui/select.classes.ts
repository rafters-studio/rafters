...
const triggerClasses =
  ...
  'border border-input bg-background px-3 py-2 ts-body-small shadow-sm ring-offset-background ' +
...
const labelClasses = 'py-1.5 pl-8 pr-2 ts-label-medium text-muted-foreground';
