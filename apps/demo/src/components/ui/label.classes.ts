import type { LabelConfig, LabelState, LabelVariant } from '@/components/ui/label.behavior';
 ...
 * settled decoration -- `ts-label-medium` is the semantic typography role
 * token, never a raw font size.
 */
const labelBaseClasses =
  'ts-label-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70';
