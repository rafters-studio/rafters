...
} from '@/components/ui/typography.behavior';
import { resolveTypography } from '@/components/ui/typography.classes';
...
export { resolveTypography, typographyClasses } from '@/components/ui/typography.classes';
export { variantToTag };
