...
import type { InlineContent, InlineMark } from '@/lib/primitives/types';
...
function useEditableHeading({
  ...
  useEffect(() => {
    ...
    // On first mount, initialize ref from DOM (React rendered the children)
    if (!mountedRef.current) {
      mountedRef.current = true;
      lastContentRef.current = element.textContent ?? '';
      return;
    }
