...
import { createClassy } from '@/lib/primitives/classy';
...
import {
  ...
  type AccordionPart,
  type AccordionState,
} from '@/components/ui/accordion.behavior';
import { accordionClasses, type AccordionClassSet } from '@/components/ui/accordion.classes';
